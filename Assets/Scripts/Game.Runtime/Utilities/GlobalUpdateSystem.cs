    ...
    public class GlobalUpdateSystem : Singleton<GlobalUpdateSystem>
    {
        ...
        public void Add(IUpdateSystem update)
        {
            ...
            else
            {
                ...
                {
                    throw new Exception($"Object is exist in updates: {update}");
                }
            }
        }
        ...
        /// <summary>
        /// check whether update is exist.
        /// </summary>
        /// <param name="updateSystem"></param>
        /// <returns></returns>
        public bool Contains(IUpdateSystem updateSystem)
        {
            return this.updates.Contains(updateSystem);
        }
    }
}
